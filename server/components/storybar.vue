   ...
   <div>
        <div v-if="state.isLoggedIn" class="flex overflow-x-scroll">
            <div class="p-2 m-1 text-center">
                <RouterLink :to="`/user/me/story`"><img :src="state.user.avatar" class="rounded-full w-16 h-16 min-w-16 min-h-16 object-fill border-2"></RouterLink>
                <RouterLink :to="`/user/me/story/create`" class="label text-sm">Add Story</RouterLink>
            </div>
